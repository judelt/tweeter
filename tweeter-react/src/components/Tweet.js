...
export const Tweet = (props) => {
  ...
  return (
    <article className="tweet">
      <header>
        <div className="user"><img src={profile_image} /><span>{name}</span></div>
        <p><strong className="account">{handle}</strong></p>
      </header>
        <p><strong>{text}</strong></p>
      <footer className="log">
        <p>{date}</p>
        <div className="icons">
          <i className="fab fa-font-awesome-flag fa-xs" aria-hidden="true"></i>
